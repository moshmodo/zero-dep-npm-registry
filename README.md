...
| Name | Full Name | Description | Stars ⭐ | npmjs.com |
|------|-----------|-------------|------:|------:|
...
| [anvil](https://github.com/tools-for-agents/anvil) | tools-for-agents/anvil | 🔨 Throwaway Docker sandbox for agents: run code/commands in isolated, resource-limited containers with structured results. CLI + web + MCP. Zero deps. | 0 | ⛔ |
| [anyall](https://github.com/b2m9/anyall) | b2m9/anyall | Build, validate, and evaluate serializable filters over declared TS fields | 1 | ✅ |
...
| [avoidMeanBoss](https://github.com/Ludan-daye/avoidMeanBoss) | Ludan-daye/avoidMeanBoss | 用 OpenAlex 公开数据看导师是否倾向于在师生合著论文上挂一作。纯静态零后端，分数即百分比本身，字母序学科���样本不足时拒答而非猜测。 | 0 | ⛔ |
...
| [Baka-Search](https://github.com/1cyberlangke1/Baka-Search) | 1cyberlangke1/Baka-Search | 笨蛋想法的笨蛋实现 | 4 | ⛔ |
...
| [baylabs](https://github.com/digtaalfathir/baylabs) | digtaalfathir/baylabs | Dependency-light Node.js utilities for backend & IoT. Published under @digta on npm. | 0 | ⛔ |
...
| [camel-keys](https://github.com/fahdi/camel-keys) | fahdi/camel-keys | Convert JSON object's keys to camelCase from hyphen-case  | 5 | ✅ |
...
| [codeindex](https://github.com/maxgfr/codeindex) | maxgfr/codeindex | Zero-dependency repo-indexing engine: deterministic walk + symbol/import extraction (tree-sitter AST with regex fallback) + typed cross-file link-graph + analytics. One vendorable engine.mjs, CLI + MCP server included. | 0 | ✅ |
...
| [confer](https://github.com/rohansx/confer) | rohansx/confer | Highlight text in local HTML docs and ask a headless Claude Code agent in your repo - code-grounded answers, doc edits, and an in-browser file finder. | 1 | ⛔ |
...
| [dep-xray](https://github.com/Makeph/dep-xray) | Makeph/dep-xray | Supply-chain forensics for package.json - zero-dependency, in-browser npm risk scanner | 1 | ⛔ |
...
| [dotkit](https://github.com/Virgile-pct/dotkit) | Virgile-pct/dotkit | Micro-bibliothèque UX brutaliste à mouvement quantifié — 13 modules, zéro dépendance | 1 | ⛔ |
...
| [drain-ts](https://github.com/AgentiX-E/drain-ts) | AgentiX-E/drain-ts | A production-ready TypeScript/Node.js streaming log template miner — 1:1 port of the official Python Drain3 algorithm. Extracts structured templates from unstructured logs in real time using fixed-depth prefix tree clustering with zero runtime dependencies. | 0 | ⛔ |
| [drama-forge](https://github.com/sk-arr/drama-forge) | sk-arr/drama-forge | 短剧工坊 · 面向短剧/短视频业务的 AI 效率工具集(热点追踪·剧本转分镜·爆款文案·素材整理·AI 周报)。零依赖 Node + 原生前端,本地优先,兼容 DeepSeek/Kimi/通义等 OpenAI 兼容接口。 | 2 | ⛔ |
...
| [finance-tracker](https://github.com/Michael-WhiteCapData/finance-tracker) | Michael-WhiteCapData/finance-tracker | Self-hosted, local-first personal finance tracker — subscriptions, budgets, alerts & overdraft forecasting, with optional real-time bank sync via SimpleFIN. Zero dependencies. | 2 | ⛔ |
...
| [folex](https://github.com/ElBenjaMasLindo/folex) | ElBenjaMasLindo/folex | Lightweight, LLM-friendly layering library that makes plain HTML look magical. | 0 | ✅ |
| [ForgeDialog](https://github.com/cmm-cmm/ForgeDialog) | cmm-cmm/ForgeDialog | Lightweight, dependency-free TypeScript dialogs with accessible modals, drawers, workflows, animations, theming, and draggable interactions. | 0 | ⛔ |
| [forgekit](https://github.com/CodeWithJuber/forgekit) | CodeWithJuber/forgekit | One config for every AI coding agent — cross-tool config + a cognitive substrate (memory, blast-radius, guardrails) for Claude Code, Codex, Cursor, Gemini, Aider, and more. | 3 | ✅ |
...
| [github-profile-stats](https://github.com/shinpr/github-profile-stats) | shinpr/github-profile-stats | A zero-runtime-dependency GitHub Action that generates static SVG profile cards with full-year contributions and public metrics. | 1 | ⛔ |
...
| [grindstone](https://github.com/19nsimon/grindstone) | 19nsimon/grindstone | Local-first personal AI workspace: calendar, tasks, email, notes, and live Claude sessions in one dashboard, with scheduled agents under a consent-first autonomy policy. Zero-dependency Node server, markdown you own. | 0 | ⛔ |
...
| [guardpost](https://github.com/sibshahz/guardpost) | sibshahz/guardpost | Import-Time Behavioral Policy Engine for Node.js Dependencies Declare what your npm packages are allowed to do — and kill them instantly if they violate policy. | 0 | ✅ |
...
| [html-editor](https://github.com/AmoryMing/html-editor) | AmoryMing/html-editor | HTML 编辑器 freeze-edit：本地可视化（WYSIWYG）编辑 AI 生成的 HTML 设计稿/PRD——动态稿一键冻结为静态、双击改字、跨文件复制卡片不丢样式、元素级评论、局域网多人共编、保存自动备份。零依赖两个文件。Local WYSIWYG editor for AI-generated HTML. | 0 | ⛔ |
...
| [ICM-Protocols](https://github.com/cleaneramade/ICM-Protocols) | cleaneramade/ICM-Protocols | A local control panel for AI rules, app permissions, skills, and secrets — zero dependencies, nothing leaves your machine. | 1 | ⛔ |
...
| [iris](https://github.com/tools-for-agents/iris) | tools-for-agents/iris | 👁 The agent's eye: render what you built at real viewports and themes, and measure what a glance would catch — overflow, clipping, contrast, unreadable type, collisions, design drift, dead game loops. CLI + web + MCP. Zero deps. | 0 | ⛔ |
...
| [key-event-plus](https://github.com/jeeanribeiro/key-event-plus) | jeeanribeiro/key-event-plus | Tiny, zero-dependency keyboard listener with full TypeScript types and international layout support | 1 | ⛔ |
| [key-router](https://github.com/infoallin1eventsllc-sys/key-router) | infoallin1eventsllc-sys/key-router | Zero-dependency API key failover proxy — circuit breakers, windowed metering, contract-tested schemas. Grafana-style React dashboard included. | 0 | ⛔ |
...
| [lens](https://github.com/tools-for-agents/lens) | tools-for-agents/lens | 🔎 Token-efficient code & doc retrieval for agents: FTS5 search, symbol outlines, surgical reads. CLI + web + MCP. Zero deps. | 0 | ⛔ |
...
| [llm-wiki-governance](https://github.com/Dowon-Kim7949/llm-wiki-governance) | Dowon-Kim7949/llm-wiki-governance | Governance for AI-written project docs — verify, catch drift, keep them code-grounded, enforce in CI. Zero-dependency, OKF-compatible. | 4 | ✅ |
...
| [oai-style-cover](https://github.com/cyrus-cai/oai-style-cover) | cyrus-cai/oai-style-cover | Nine editorial cover styles, drawn with Canvas 2D. No image model, no dependencies, no build step. | 0 | ⛔ |
...
| [pipzzle](https://github.com/kiy995/pipzzle) | kiy995/pipzzle | pipzzle is a small pipe puzzle game where you rotate tiles to connect every pipe. | 0 | ⛔ |
...
| [postgis-query-explain](https://github.com/geospatial-api/postgis-query-explain) | geospatial-api/postgis-query-explain | Visual EXPLAIN ANALYZE breakdown for PostGIS queries, with GiST/SP-GiST/BRIN index suggestions and spatial rewrite hints. Zero-dependency static web app. | 0 | ⛔ |
...
| [prism](https://github.com/tools-for-agents/prism) | tools-for-agents/prism | 🔻 The agent's data reader: any JSON/JSONL/CSV/TSV blob becomes its shape and the slice you asked for, not the whole thing. Zero-dep, CLI + web + MCP. | 0 | ⛔ |
...
| [qrp](https://github.com/nemanjan00/qrp) | nemanjan00/qrp | A data-first, declarative, low-overhead framework for dashboards. Zero RUNTIME dependencies, zero build step — the devDependencies below are only for tests, lint, and git hooks. | 1 | ✅ |
...
| [react-pulsor](https://github.com/syoooo/react-pulsor) | syoooo/react-pulsor | Composable React loading indicators — grids, bars and dots, in lines or loops, driven by phase fields, motion envelopes and OKLab gradients. Zero dependencies. | 3 | ✅ |
...
| [recall](https://github.com/tools-for-agents/recall) | tools-for-agents/recall | 🎯 Federated recall across an agent's knowledge — cortex, agent-hq, scout and lens — in one token-budgeted query. CLI + web + MCP. Zero deps. | 0 | ⛔ |
| [recurring-free-slots](https://github.com/bhumik154/recurring-free-slots) | bhumik154/recurring-free-slots | Compute a day's free time slots from recurring weekly busy blocks: handles overnight-wrapping and overlapping blocks correctly. Zero dependencies. | 0 | ⛔ |
...
| [roundtable](https://github.com/ai-us-stock-lab/roundtable) | ai-us-stock-lab/roundtable | One table for all your AI CLIs: everyday multi-model group chat + structured debate committee. Rides your CLI subscriptions, zero dependencies. | 1 | ⛔ |
| [rowcodec](https://github.com/ainoya/rowcodec) | ainoya/rowcodec | Map flat ORM rows (LEFT JOIN output) into nested, aggregated domain objects — and back. ORM-agnostic, functional, zero-dependency, fully type-inferred. | 0 | ⛔ |
...
| [safi-image](https://github.com/Abdulkader-Safi/safi-image) | Abdulkader-Safi/safi-image | Pure TypeScript image editing for Node and Bun. PNG, JPEG, WebP, GIF, BMP, TIFF. No native binaries. 23 KB core. | 2 | ✅ |
...
| [sasaki-agent](https://github.com/peachcardinal/sasaki-agent) | peachcardinal/sasaki-agent | Личный агент поиска работы: 19 источников вакансий, локальный пульт с фильтрами и трекером откликов. Работает на твоём компьютере. | 0 | ⛔ |
...
| [scout](https://github.com/tools-for-agents/scout) | tools-for-agents/scout | 🧭 The agent's web reader: fetch a URL as clean, cached, searchable markdown (~90% smaller than HTML). Pairs with cortex. CLI + web + MCP. Zero deps. | 0 | ⛔ |
...
| [shufffle](https://github.com/Adam-Robson/shufffle) | Adam-Robson/shufffle | Dependency-free reverse proxy for Nodejs. | 0 | ⛔ |
...
| [sparklify](https://github.com/KabirAcharya/sparklify) | KabirAcharya/sparklify | Tiny zero-dependency visual micro-library for polished status cards and celebratory sparkles. | 0 | ⛔ |
...
| [static-markdown-blog](https://github.com/MG5921MY/static-markdown-blog) | MG5921MY/static-markdown-blog | 零依赖静态博客平台，5 个原创主题，i18n，自定义页面系统 | 2 | ⛔ |
...
| [supportkit-js](https://github.com/jair10crack/supportkit-js) | jair10crack/supportkit-js | Zero-dependency TypeScript toolkit for support/helpdesk teams: ticket priority classification, business-hours SLA tracking, and a framework-free DOM badge helper. JS/TS companion to the Python supportkit package. | 0 | ⛔ |
...
| [terlio](https://github.com/DrA1ex/terlio) | DrA1ex/terlio | Terminal UI for live, interactive workflows. | 0 | ⛔ |
...
| [weave](https://github.com/codeyogi911/weave) | codeyogi911/weave | Stitch records from heterogeneous sources into one connected, traversable graph your code and agents read as a single thing. Pure TypeScript, zero deps, no database. | 0 | ✅ |
...
| [zero-dep-npm-registry](https://github.com/moshmodo/zero-dep-npm-registry) | moshmodo/zero-dep-npm-registry | A curated index of npm packages with zero dependencies — lightweight, secure, and self-contained. | 0 | ⛔ |
...
| [zeshim](https://github.com/Santazuki/zeshim) | Santazuki/zeshim | Complexity drops from N×M to N+M — protocol-driven, zero-dependency LLM provider shim. | 2 | ⛔ |
...
| [zpi-sdk](https://github.com/zeative/zpi-sdk) | zeative/zpi-sdk | Universal zero-dependency TypeScript SDK for the Zapi (Zest API) scraper platform | 2 | ✅ |
